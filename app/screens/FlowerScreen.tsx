                        ...
                        <Card style={styles.card}>
                            ...
                            <Card.Content>
                                ...
                                <TouchableOpacity onPress={() => addToCart(item)}>
                                    <Icon name={"cart"} size={30} color={"#ff8500"} style={styles.btn} />
                                </TouchableOpacity>
                            </Card.Content>
                        </Card>
                    );
            ...
            <Modal transparent visible={favoritesModalVisible} animationType="none">
                <Animated.View style={[styles.modalContainer, { transform: [{ translateY: slideAnim }] }]}>
                    <View style={styles.modalHeader}>
                        <Text style={styles.modalTitle}>Favorite Tools</Text>
...
const styles = StyleSheet.create({
    ...
    title: { fontSize: 22, fontWeight: "bold", color: "#363636" , margin:10},
    ...
    modalHeader: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", padding: 15, backgroundColor: "#d98324", borderTopLeftRadius: 20, borderTopRightRadius: 20 },
