...
export default function RegisterScreen() {
    ...
    return (
        <KeyboardAvoidingView style={styles.container}>
            <LottieView
                source={require("../assets/json/Animation - 1740754287192.json")}
                autoPlay
                loop
                style={{
                    width: 100,
            ...
            />
            <Text style={{ fontSize: 24, fontFamily: "Poppins_700Bold", textAlign: "center", color: "#D98324", marginVertical: -5 }}>
                Welcome to Hotjar
            </Text>
            <Text style={{ color: "#443627", textAlign: "center", fontFamily: "Poppins_500Medium", marginBottom: 20 }}>
                Sign up to continue
            </Text>
